...
- [ ] **Step 1: Write failing initial-theme tests**
...
- [ ] **Step 3: Implement pre-construction theme state**
...
- [ ] **Step 4: Run theme and GUI tests**
...
- [ ] **Step 3: Implement the immutable task catalog**
...
- [ ] **Step 4: Implement runner state and signals**
...
- [ ] **Step 1: Write failing process-strategy tests**
...
- [ ] **Step 2: Implement direct execution**
...
- [ ] **Step 3: Implement the terminal bridge**
...
- [ ] **Step 1: Write failing deployment-page tests**
...
- [ ] **Step 3: Bind preview, confirmation, run, and cancel**
...
- [ ] **Step 4: Bind runner output and completion**
...
- [ ] **Step 2: Implement the runtime checks**
